    ...
    return (
        <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg ring-1 ring-gray-200">
            ...
            <div className="mt-6 min-h-[100px]">
                ...
                {error && <div className="bg-gray-50 p-6 rounded-lg border border-gray-200"><p className="text-red-500 text-sm">{error}</p></div>}
                ...
                {analysis && (
                    <>
                        <div id="analysis-content-to-pdf" className="bg-white p-6">
                            ...
                            <div className="prose prose-sm max-w-none text-gray-700" style={{ whiteSpace: 'pre-wrap' }}>{analysis}</div>
                        </div>
                        <div className="text-center mt-6">
                            <button
                                onClick={handleDownloadPdf}
                                className="bg-[#3d7a74] text-white font-semibold py-2.5 px-6 rounded-full shadow-lg hover:bg-[#4A908A] transition-colors duration-300"
                            >
